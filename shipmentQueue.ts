...
export default class ShipmentQueue {
  ...
  public async addToQueue(id: string, promise: Promise<OperationResult>) {
  ...
  private createPromiseChaining(array: Array<Promise<OperationResult>>) {
